...
- **Testimonial stage**: near-black (`#0b0d12` family) rounded panel, white quote type, muted role label
...
- **Eyebrow / labels**: 16px with positive letter-spacing (~2px) on some uppercase-adjacent UI labels
