...
AAA24 is A24’s **membership and account world** — more boutique club than neon streaming store. The system mixes warm paper neutrals (`#f5f1ea`) with muted stone grays (`#837e77`), big photography, and calm typography. It feels tactile and editorial, like print collateral extended to the web.
...
Dinamo’s site is a **type foundry storefront** that refuses generic marketing chrome. Black, white, and a sharp purple accent (`#6e32e1`) frame enormous specimen type. Navigation is utilitarian; the font is the spectacle. Hardware and news surfaces keep the same blunt, design-studio confidence.
...
[![How ads.pinterest.com is designed](https://pin.fontofweb.com/7069?format=jpg)](design-md/ads.pinterest.com.md)
...
[![How agentation.dev is designed](https://pin.fontofweb.com/6234?format=jpg)](design-md/agentation.dev.md)
...
[![How ahrefs.com is designed](https://pin.fontofweb.com/7045?format=jpg)](design-md/ahrefs.com.md)
...
Ahrefs Evolve is an **event microsite** that borrows Ahrefs’ orange energy but stages it like a conference trailer: black ground, oversized white “evolve” wordmarks, live stage photography, and pill CTAs. Location chips (San Diego / Singapore) and date stacks sit in a poster composition. It is louder and more editorial than the main product pricing page—built for tickets and lineup, not SEO tables.
...
ami.dev is a **typographic personal/developer site**: cream or soft paper ground, black grotesk headlines at confident sizes, and almost no decorative system beyond text, links, and spacing. It feels closer to a carefully set résumé-essay hybrid than a product landing page. Personality comes from writing and hierarchy, not illustration kits.
...
Anytype markets itself as a **dark, local-first knowledge universe**: black canvas, soft gradient orbs, large white sans headlines, and product screenshots floating in rounded frames. Pricing continues the dark system with comparison cards and a clear highlighted plan. It feels cosmic and calm rather than corporate light-mode productivity.
...
Scira’s API marketing presents as a **modern AI developer landing**: strong hero headline, product/API emphasis, and a contemporary startup composition that prioritizes trying or understanding the API quickly. Captures are primarily home views at multiple widths—use them as a marketing system, not a full console design.
...
[![How app.flora.ai is designed](https://pin.fontofweb.com/7888?format=jpg)](design-md/app.flora.ai.md)
...
[![How app.reve.com is designed](https://pin.fontofweb.com/8369?format=jpg)](design-md/app.reve.com.md)
...
[![How app.useorigin.com is designed](https://pin.fontofweb.com/8924?format=jpg)](design-md/app.useorigin.com.md)

Origin Financial pairs a **premium dark brand moment** with a **clean light product shell**. Marketing/sign-up screens use deep navy-black fields, oversized editorial headlines, and a crisp cyan wordmark. Inside the app, the system flips to white surfaces, slate text, soft cards, and the same cyan as the interactive accent—finance UI that feels modern rather than bank-beige.
...
[![How artsandculture.google.com is designed](https://pin.fontofweb.com/7269?format=jpg)](design-md/artsandculture.google.com.md)

Google Arts & Culture is a **media-first cultural magazine** built on Google’s light system: white canvas, Google Blue links (`#1a73e8`), gray body (`#202124` / `#3c4043` / `#80868b`), and generous story cards. Art and photography always outrank chrome; UI is a quiet librarian for huge cultural media.
...
ArtStation is a **dark creative marketplace shell** built to disappear behind artwork. Near-black headers, compact icon nav, and dense image carousels/grids mean the UI is a stagehand: small type (~14px), minimal labels, and high-contrast controls (blue Upgrade pill) against a charcoal frame.
...
[![How ashmolean.org is designed](https://pin.fontofweb.com/6596?format=jpg)](design-md/ashmolean.org.md)

The Ashmolean site is **institutional calm**: warm light pages, near-black text (`#231f20`), gray secondary (`#444444`), and photography of objects and spaces doing the emotional work. Typography mixes approachable sans with occasional serif display for heritage campaigns. It feels like a museum brochure translated to the web—generous, legible, unflashy.
...
[![How audio.com is designed](https://pin.fontofweb.com/6238?format=jpg)](design-md/audio.com.md)

audio.com is a **dark creator audio platform**: deep charcoal/black fields, light primary text (`#f2f1f4`), muted gray secondary (`#67656d` / `#a7a5aa`), and hot magenta/pink CTAs (`#ff465f`) on marketing surfaces—with green (`#02ba29`) appearing as a success/plan accent on subscriptions. Floating white player mini-cards and waveform UI make the product feel audible even in stills.

[Open guide](design-md/audio.com.md) · [View the Fudge conversation](https://design.withfudge.com/share/audio.com-design)

### aura.build

[![How aura.build is designed](https://pin.fontofweb.com/8658?format=jpg)](design-md/aura.build.md)
...
[![How awwwards.com is designed](https://pin.fontofweb.com/3078?format=jpg)](design-md/awwwards.com.md)
...
[![How base-ui.com is designed](https://pin.fontofweb.com/3864?format=jpg)](design-md/base-ui.com.md)
...
[![How base44.com is designed](https://pin.fontofweb.com/7405?format=jpg)](design-md/base44.com.md)
...
[![How baselight.ai is designed](https://pin.fontofweb.com/7848?format=jpg)](design-md/baselight.ai.md)
...
[![How behance.net is designed](https://pin.fontofweb.com/7311?format=jpg)](design-md/behance.net.md)
...
[![How bland.ai is designed](https://pin.fontofweb.com/9665?format=jpg)](design-md/bland.ai.md)
...
[![How bolt.new is designed](https://pin.fontofweb.com/6000?format=jpg)](design-md/bolt.new.md)
...
Browserbase sells browser infrastructure for AI agents with a **sharp, technical** visual voice: high contrast surfaces, very large display lines (~56–66px), compact UI labels (14–20px), **2px borders**, and tiny radii (1–2px) that feel closer to terminals and schematics than soft consumer SaaS. Home and pricing share the same austere precision.
...
BrowserOS markets an open-source agentic browser with a **warm, editorial** tone rather than cold infra chrome. The canvas is soft ivory/off-white with a subtle grid texture, display lines mix **black roman and orange italic emphasis**, CTAs are dark brown/black pills, and product proof is a large rounded browser mockup floating over gentle photography.
...
[![How builtwith.kit.com is designed](https://pin.fontofweb.com/6374?format=jpg)](design-md/builtwith.kit.com.md)
...
[![How caffeine.ai is designed](https://pin.fontofweb.com/7229?format=jpg)](design-md/caffeine.ai.md)

Caffeine is a **dark, high-contrast AI product** with two related moods: 1. **Marketing/info** — near-black full bleed, pale text, electric lime accent (`#ddf730`), large light display lines 2. **In-product settings** — denser panels, soft periwinkle accent (`#9cb1f4`), gray secondary text, compact controls
...
[![How campaignlive.co.uk is designed](https://pin.fontofweb.com/7890?format=jpg)](design-md/campaignlive.co.uk.md)

Campaign Live is a **B2B advertising trade publication**: red brand accents (`#ff0000` / `#c5001d`), charcoal type (`#1c1c1c`), dense information hierarchy, and clear membership/paywall surfaces. It feels industry-press rather than startup-SaaS—editorial authority first.
...
[![How canadaspends.com is designed](https://pin.fontofweb.com/6906?format=jpg)](design-md/canadaspends.com.md)
...
Capacity markets AI website/MVP building with a **dark, spacious product-site system**: near-black grounds, white primary text, zinc secondary (`#a1a1aa`), soft large radii, and big display type. Pages for clone-website, MVP builder, pricing, and home share the same calm dark chrome so demos and CTAs can pop.
...
[![How carcard.arible.co is designed](https://pin.fontofweb.com/7743?format=jpg)](design-md/carcard.arible.co.md)
...
[![How catala-lang.org is designed](https://pin.fontofweb.com/9001?format=jpg)](design-md/catala-lang.org.md)
...
[![How cavalry.scenegroup.co is designed](https://pin.fontofweb.com/7157?format=jpg)](design-md/cavalry.scenegroup.co.md)

Cavalry’s web marketing is **bold creative-tool branding**: electric purple panels (`#6437ff` family), stark black/white type, neon lime geometric line art, and pill-shaped CTAs. Teams and pricing pages feel confident and graphic—closer to a design studio poster than soft SaaS pastels.
...
[![How celesteduffy.com is designed](https://pin.fontofweb.com/7856?format=jpg)](design-md/celesteduffy.com.md)
...
[![How chainlift.io is designed](https://pin.fontofweb.com/6345?format=jpg)](design-md/chainlift.io.md)
...
[![How chatgpt.com is designed](https://pin.fontofweb.com/10040?format=jpg)](design-md/chatgpt.com.md)
...
[![How classy.md is designed](https://pin.fontofweb.com/10089?format=jpg)](design-md/classy.md.md)
...
[![How claura.framer.ai is designed](https://pin.fontofweb.com/8120?format=jpg)](design-md/claura.framer.ai.md)
...
[![How clubhouse.com is designed](https://pin.fontofweb.com/7584?format=jpg)](design-md/clubhouse.com.md)
...
[![How codepen.io is designed](https://pin.fontofweb.com/8436?format=jpg)](design-md/codepen.io.md)
...
[![How cofounder.co is designed](https://pin.fontofweb.com/8169?format=jpg)](design-md/cofounder.co.md)
...
[![How cosmos.so is designed](https://pin.fontofweb.com/8592?format=jpg)](design-md/cosmos.so.md)
...
[![How cotool.ai is designed](https://pin.fontofweb.com/8601?format=jpg)](design-md/cotool.ai.md)
...
[![How cypherpunkbooks.com is designed](https://pin.fontofweb.com/9525?format=jpg)](design-md/cypherpunkbooks.com.md)
...
D&AD is a **design-award institution on the web**: authoritative, editorial, and archive-forward. Captures cover the home, search, and New Blood archive—surfaces that prioritize **work discovery and cultural gravitas** over startup marketing chrome. Expect strong typographic hierarchy, generous indexing patterns, and a gallery/archive mindset where the **creative work is the color**.
...
dany.works is a **studio/personal works site** concentrated on the home experience (seven `/` captures). It should feel like a **crafted studio billboard**: confident type, curated work presence, and a designer’s hand in spacing—closer to a portfolio monograph than a multi-page corporate marketing funnel.
...
Dropbox Dash presents as a **product dashboard/marketing-hybrid under dash.dropbox.com**, with a general home surface and a branded collaboration moment (`/mclarenf1`). The system should feel like **Dropbox-adjacent product UI**: clean, modern, content-and-file aware, with room for partner/campaign skins without losing the base console clarity.
...
[![How davidprotein.com is designed](https://pin.fontofweb.com/7831?format=jpg)](design-md/davidprotein.com.md)

David Protein is a **premium CPG ecommerce brand**: cinematic product photography, oversized display type (55–80px), and a dual mode of **dark immersive home** versus **light merchandising** (bundle builder, about, FAQ). A muted gold accent (`#b59f4a`) marks brand warmth on light commerce surfaces; white/`#dcdcdc` type rides photography on dark hero moments.
...
[![How deezer.com is designed](https://pin.fontofweb.com/7883?format=jpg)](design-md/deezer.com.md)
...
[![How dfinity.org is designed](https://pin.fontofweb.com/7230?format=jpg)](design-md/dfinity.org.md)
...
[![How diabrowser.com is designed](https://pin.fontofweb.com/3811?format=jpg)](design-md/diabrowser.com.md)
...
[![How discord.com is designed](https://pin.fontofweb.com/788?format=jpg)](design-md/discord.com.md)
...
[![How dotprolabs.com is designed](https://pin.fontofweb.com/7490?format=jpg)](design-md/dotprolabs.com.md)

DotPro Labs is a **dark-mode creative engineering studio** site that shouts in billboard type. The hero stacks **DESIGN / DEVELOP** in oversized cream condensed letters and slaps a fluorescent **DEPLOY** sticker in hot orange. Glassmorphic 3D orbs float in the void. Below, logo proof and case-study mockups keep the black field. It is aggressive, portfolio-forward, and unapologetically agency.
...
[![How drinkag1.com is designed](https://pin.fontofweb.com/6218?format=jpg)](design-md/drinkag1.com.md)

AG1’s site is **premium wellness ecommerce** executed in a strict **black-and-white** foundation with photography doing the emotional work. Large product stills (canister, pouch, lifestyle) sit on clean fields; typography is bold, direct, and conversion-minded (“More than a greens powder”). Partner/get-started flows keep the same high-contrast discipline.
...
[![How dzen.ru is designed](https://pin.fontofweb.com/8995?format=jpg)](design-md/dzen.ru.md)
...
[![How edition.cnn.com is designed](https://pin.fontofweb.com/9105?format=jpg)](design-md/edition.cnn.com.md)
...
[![How elevenlabs.io is designed](https://pin.fontofweb.com/9194?format=jpg)](design-md/elevenlabs.io.md)
...
Emmi Wu’s portfolio is airy, gallery-like, and type-forward: large clean sans headlines, generous whitespace, and project imagery as the color story. It reads as contemporary design-personal branding—quiet chrome, strong hierarchy, no template clutter.
...
[![How epsteinexposed.com is designed](https://pin.fontofweb.com/6926?format=jpg)](design-md/epsteinexposed.com.md)
...
[![How etched.com is designed](https://pin.fontofweb.com/9867?format=jpg)](design-md/etched.com.md)
...
[![How everyday-practice.com is designed](https://pin.fontofweb.com/10372?format=jpg)](design-md/everyday-practice.com.md)
...
[![How exa.ai is designed](https://pin.fontofweb.com/9592?format=jpg)](design-md/exa.ai.md)

Exa is a polished developer/AI search brand. The home and customer stories sit on clean white (or near-white) canvases with black type, a strong electric blue accent (`#1f40ed`), and soft rounded cards. It feels modern API-platform marketing: confident, minimal, slightly editorial, never neon-cyber.

[Open guide](design-md/exa.ai.md) · [View the Fudge conversation](https://design.withfudge.com/share/exa.ai-design)

### explainers.blog

[![How explainers.blog is designed](https://pin.fontofweb.com/6335?format=jpg)](design-md/explainers.blog.md)

Explainers is a light, patient educational blog. Articles live in a centered white reading column with charcoal body text and indigo/violet accents (`#5b5bfd`, `#31359d`). Titles can jump to ~70px bold; body stays comfortable and open. It feels like a modern science explainer — clear, friendly, not startup-landing loud.
...
[![How factory.ai is designed](https://pin.fontofweb.com/6815?format=jpg)](design-md/factory.ai.md)

Factory is stark black enterprise-devtool marketing. Pages are near-void black with white type, hairline dividers, monochrome integration marks, and tiny orange status dots as rare warmth. Geometry is restrained (4–8px radii). The mood is serious, agent-native, security-aware — more terminal night mode than playful AI.

[Open guide](design-md/factory.ai.md) · [View the Fudge conversation](https://design.withfudge.com/share/factory.ai-design)

### familytype.co

[![How familytype.co is designed](https://pin.fontofweb.com/5472?format=jpg)](design-md/familytype.co.md)

Family Type is a dark, precise type foundry commerce UI. Black surfaces, light gray secondary text, and a mint/neon green (`#05df72`) for prices, checks, and selected borders. Rows and panels use ~14px radii. It feels like a high-end font PDP + configurator: dense information, calm chrome, green only for money and selection.
...
[![How flickr.com is designed](https://pin.fontofweb.com/8225?format=jpg)](design-md/flickr.com.md)
...
[![How flowgenie.pro is designed](https://pin.fontofweb.com/7692?format=jpg)](design-md/flowgenie.pro.md)
...
[![How foundation.app is designed](https://pin.fontofweb.com/8481?format=jpg)](design-md/foundation.app.md)
...
[![How fourmula.ai is designed](https://pin.fontofweb.com/8674?format=jpg)](design-md/fourmula.ai.md)
...
[![How frankchimero.com is designed](https://pin.fontofweb.com/7426?format=jpg)](design-md/frankchimero.com.md)
...
[![How frontify.com is designed](https://pin.fontofweb.com/6107?format=jpg)](design-md/frontify.com.md)
...
Fushly is a **bright fintech/credits marketplace** for startup perks: white canvas, charcoal ink (`#1a1d23`), and a vivid green accent (`#2dd17f` / `#25b06a`). The system is friendly PLG — huge bold headlines (up to ~72px/700), pill CTAs, soft 12–16px cards, and catalog tiles for cloud/AI credits. Login continues the same green-on-light language with rounded forms.

[Open guide](design-md/fushly.com.md) · [View the Fudge conversation](https://design.withfudge.com/share/fushly.com-design)

### gaio.club

[![How gaio.club is designed](https://pin.fontofweb.com/8015?format=jpg)](design-md/gaio.club.md)
...
[![How gazeta.ru is designed](https://pin.fontofweb.com/9101?format=jpg)](design-md/gazeta.ru.md)
...
[![How grokipedia.com is designed](https://pin.fontofweb.com/9343?format=jpg)](design-md/grokipedia.com.md)
...
[![How harvey.ai is designed](https://pin.fontofweb.com/8737?format=jpg)](design-md/harvey.ai.md)
